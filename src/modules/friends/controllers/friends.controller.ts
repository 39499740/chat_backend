...
export class FriendsController {
  ...
  async sendRequest(@CurrentUser() user: any, @Body() sendFriendRequestDto: SendFriendRequestDto) {
  ...
  async acceptRequest(@CurrentUser() user: any, @Param('requestId') requestId: string) {
  ...
  async rejectRequest(@CurrentUser() user: any, @Param('requestId') requestId: string) {
  ...
  async deleteFriend(@CurrentUser() user: any, @Param('friendId') friendId: string) {
  ...
  async checkFriendship(@CurrentUser() user: any, @Param('friendId') friendId: string) {
